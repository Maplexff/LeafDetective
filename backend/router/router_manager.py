...
from torchimg.fastapimain import torchimg
from module_history.controller.history_controller import historyController
...
admin_controllers = [
    ...
    {'router': torchimg, 'tags': ['图像处理']},
    {'router': historyController, 'tags': ['历史记录']}
